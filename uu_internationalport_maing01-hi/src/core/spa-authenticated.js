...
import PiersList from "../routes/piers-list";
import PierDetails from "../routes/pier-details";
import BoatsList from "../routes/boats-list";
//@@viewOff:imports
...
const ROUTES = {
  ...
  piersList: { component: <PiersList /> },
  pierDetails: { component: <PierDetails /> },
  boatsList: { component: <BoatsList /> },
};
