const Lsi = {
  appName: {
    cs: "Aplikace uuInternationalport",
    en: "Application uuInternationalport",
  },
  ...
  about: {
    header: {
      cs: "O aplikaci uuInternationalport",
      en: "About application uuInternationalport",
    },
    creatorsHeader: {
      cs: "Tvůrci aplikace",
  ...
  unauthInit: {
    buyYourOwn: {
      cs: "Můžete si koupit vlastní uuInternationalport.",
      en: "You can buy your own uuInternationalport.",
    },
    notAuthorized: {
      cs: "Nemáte právo inicializovat tuto aplikaci uuInternationalport.",
      en: "You don't have rights to initialize this uuInternationalport.",
    },
  },
